...
function TransactionTable({ transactions, onEdit, onDelete, loading }) {
  const columns = [
    { name: 'Date', selector: row => row.date, sortable: true },
    { name: 'Type', selector: row => row.type_transaction, sortable: true },
  ...
  return (
    <div className="w-full">
      <DataTable
        ...
        dense
        striped
        noDataComponent="Aucune transaction"
